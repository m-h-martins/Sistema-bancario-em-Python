...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if excedeu_limite:
            ...
            print("\nOperação falhou, número de saques excedeu o limite de saques!")
...
def criar_cliente(clientes):
    ...
    data_nascimento = str(input('Digite a data de nascimento (dd/mm/aaa): '))
    ...
    print(f'{'Novo usuário criado com sucesso!'}:=^20')
